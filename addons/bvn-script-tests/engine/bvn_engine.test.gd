...
func test_next_only_moves_within_same_chapter():
	...
	var chapter_1 :BVN_Chapter= BVNInternal.add_child(engine, BVN_Chapter.new(), Node.INTERNAL_MODE_DISABLED)
	chapter_1.name = "chapter_1"
	var page_1_1 :BVN_Page = BVNInternal.add_child(chapter_1, BVN_Page.new(), Node.INTERNAL_MODE_DISABLED)
	page_1_1.name = "page_1_1"
	page_1_1.page_data = page_data
	var page_1_2 :BVN_Page = BVNInternal.add_child(chapter_1, BVN_Page.new(), Node.INTERNAL_MODE_DISABLED)
	page_1_2.name = "page_1_2"
	page_1_2.page_data = page_data
	var page_1_3 :BVN_Page = BVNInternal.add_child(chapter_1, BVN_Page.new(), Node.INTERNAL_MODE_DISABLED)
	page_1_3.name = "page_1_3"
	page_1_3.page_data = page_data
	
	var chapter_2 :BVN_Chapter= BVNInternal.add_child(engine, BVN_Chapter.new(), Node.INTERNAL_MODE_DISABLED)
	chapter_2.name = "chapter_2"
	var page_2_1 :BVN_Page = BVNInternal.add_child(chapter_2, BVN_Page.new(), Node.INTERNAL_MODE_DISABLED)
	page_2_1.name = "page_2_1"
	page_2_1.page_data = page_data
	var page_2_2 :BVN_Page = BVNInternal.add_child(chapter_2, BVN_Page.new(), Node.INTERNAL_MODE_DISABLED)
	page_2_2.name = "page_2_2"
	page_2_2.page_data = page_data
	var page_2_3 :BVN_Page = BVNInternal.add_child(chapter_2, BVN_Page.new(), Node.INTERNAL_MODE_DISABLED)
	page_2_3.name = "page_2_3"
	page_2_3.page_data = page_data
	
	engine.start_visual_novel()
